...
public class ShopsFavFragment extends Fragment {

    public ShopsFavFragment(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.shops_fav_fragment, container, false);
    }

    public void get_shops() {
        List<Shop> _shops = new ArrayList<>();
        String url = "http://bsy.ovh:5000/shops/favorite";
                ...
                response -> {
                    try {
                        if (response.getBoolean("success")) {
                            ...
                            RecyclerView recyclerView = getActivity().findViewById(R.id.ShopsFavFragmentRecyclerView);
