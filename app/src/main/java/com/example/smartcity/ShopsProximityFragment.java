...
public class ShopsProximityFragment extends Fragment {

    public ShopsProximityFragment(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.shops_proximity_fragment, container, false);
    }

    public void get_shops()
    {
        List<Shop> _shops = new ArrayList<>();
        String url = "http://bsy.ovh:5000/shops/location?lat=";
                ...
                response -> {
                    try {
                        if (response.getBoolean("success")) {
                            ...
                            RecyclerView recyclerView = getActivity().findViewById(R.id.ShopsProximityFragmentRecyclerView);
                            ...
                            Toast.makeText(getActivity(), "Can't find any shops near you", Toast.LENGTH_SHORT).show();
                        }
                    }
